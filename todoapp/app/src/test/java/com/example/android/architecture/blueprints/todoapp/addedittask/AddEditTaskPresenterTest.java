...
public class AddEditTaskPresenterTest {
    ...
    public void populateTask_callsRepoAndUpdatesViewOnAbsentTask() {
        Task testTask = new Task("TITLE", "DESCRIPTION");
        when(mTasksRepository.getTask(testTask.getId())).thenReturn(Flowable.just(Optional.<Task>absent()));
    ...
    public void populateTask_callsRepoAndUpdatesViewOnError() {
        Task testTask = new Task("TITLE", "DESCRIPTION");
        when(mTasksRepository.getTask(testTask.getId())).thenReturn(Flowable.<Optional<Task>>error(new Throwable("Some error")));
