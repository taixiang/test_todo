...
public class TasksLocalDataSource implements TasksDataSource {
    ...
    private TasksLocalDataSource(@NonNull Context context,
        ...
        mTaskMapperFunction = new Function<Cursor, Task>() {
            @Override
            public Task apply(@io.reactivex.annotations.NonNull Cursor cursor) throws Exception {
    ...
    public Flowable<Optional<Task>> getTask(@NonNull String taskId) {
        ...
        return mDatabaseHelper.createQuery(TaskEntry.TABLE_NAME, sql, taskId)
                .mapToOneOrDefault(new Function<Cursor, Optional<Task>>() {
                    @Override
                    public Optional<Task> apply(@io.reactivex.annotations.NonNull Cursor cursor) throws Exception {
                        return Optional.of(mTaskMapperFunction.apply(cursor));
                    }
